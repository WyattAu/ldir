...
fn test_full_roundtrip() {
    ...
    module.body.push(
        nodes::Node::new(1, nodes::NodeType::Section)
            .with_label("sec:intro")
    );
    module.body.push(
        nodes::Node::new(2, nodes::NodeType::Paragraph).with_parent(1)
    );
    module.body.push(
        nodes::Node::new(3, nodes::NodeType::Text { content: "Hello, world!".to_string() })
            .with_parent(2)
    );
    module.body.push(
        nodes::Node::new(4, nodes::NodeType::Bold).with_parent(2)
    );
    module.body.push(
        nodes::Node::new(5, nodes::NodeType::Text { content: "bold text".to_string() })
            .with_parent(4)
    );
...
fn test_binary_roundtrip_preserves_all_sections() {
    ...
    module.body.push(nodes::Node::new(1, nodes::NodeType::Document));
    module.body.push(nodes::Node::new(2, nodes::NodeType::Chapter).with_parent(1));
    module.body.push(nodes::Node::new(3, nodes::NodeType::Section).with_parent(2));
    module.body.push(nodes::Node::new(4, nodes::NodeType::MathBlock {
        math_type: nodes::MathType::Equation,
        numbered: true,
    }).with_parent(3));
    module.body.push(nodes::Node::new(5, nodes::NodeType::Table {
        col_specs: vec![],
        num_cols: 0,
    }).with_parent(3));
...
fn test_text_output_contains_expected_content() {
    ...
    module.body.push(nodes::Node::new(1, nodes::NodeType::Chapter));
    module.body.push(nodes::Node::new(2, nodes::NodeType::Section).with_parent(1));
    module.body.push(nodes::Node::new(3, nodes::NodeType::Paragraph).with_parent(2));
    module.body.push(
        nodes::Node::new(4, nodes::NodeType::Text { content: "Section content here".to_string() })
            .with_parent(3)
    );
    module.body.push(
        nodes::Node::new(5, nodes::NodeType::Link { url: "https://example.com".into(), title: None })
            .with_parent(3)
    );
    module.body.push(
        nodes::Node::new(6, nodes::NodeType::CodeBlock { language: Some("rust".into()) })
            .with_parent(2)
    );
    module.body.push(
        nodes::Node::new(7, nodes::NodeType::TableOfContents { max_depth: 4 })
    );
    module.body.push(nodes::Node::new(8, nodes::NodeType::ThematicBreak));
    module.body.push(nodes::Node::new(9, nodes::NodeType::Footnote { content: "A footnote".into() }));
...
fn test_json_serialization() {
    ...
    module.body.push(nodes::Node::new(1, nodes::NodeType::Section));
...
fn test_serialize_then_disassemble_text() {
    ...
    module.body.push(nodes::Node::new(1, nodes::NodeType::Part).with_label("part:one"));
    module.body.push(nodes::Node::new(2, nodes::NodeType::Chapter).with_parent(1));
    module.body.push(nodes::Node::new(3, nodes::NodeType::Section).with_parent(2).with_label("sec:methods"));
    module.body.push(nodes::Node::new(4, nodes::NodeType::Paragraph).with_parent(3));
    module.body.push(
        nodes::Node::new(5, nodes::NodeType::Text { content: "Methods and analysis".to_string() })
            .with_parent(4)
    );
